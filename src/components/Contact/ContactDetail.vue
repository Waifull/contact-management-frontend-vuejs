<template>
  <div>
    <div class="flex items-center mb-6">
      ...
      <h1 class="text-2xl font-bold text-white flex items-center"><i class="fas fa-id-card text-blue-400 mr-3"></i> Contact Details</h1>
    </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div v-for="address in addresses" :key="address.id" class="bg-gray-700 bg-opacity-50 p-5 rounded-lg shadow-md border border-gray-600 card-hover">
              ...
              <div class="flex justify-end space-x-3">
                ...
                <button
                  v-on:click="() => handleDeleteAddress(address.id)"
