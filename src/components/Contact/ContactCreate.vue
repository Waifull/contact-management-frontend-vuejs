<template>
  <div>
    <div class="flex items-center mb-6">
      <RouterLink to="/dashboard/contacts" class="text-blue-400 hover:text-blue-300 mr-4 flex items-center transition-colors duration-200"> <i class="fas fa-arrow-left mr-2"></i> Back to Contacts </RouterLink>
      <h1 class="text-2xl font-bold text-white flex items-center"><i class="fas fa-user-plus text-blue-400 mr-3"></i> Create New Contact</h1>
    </div>
            ...
            <div>
              ...
              <div class="relative">
                ...
                <input
                  ...
                  required v-model="contact.first_name"
                />
              </div>
            </div>
            <div>
              ...
              <div class="relative">
                ...
                <input
                  ...
                  required v-model="contact.last_name"
                />
              </div>
            </div>
          </div>
          ...
          <div class="mb-5">
            ...
            <div class="relative">
              ...
              <input
                ...
                required v-model="contact.email"
              />
            </div>
          </div>
          ...
          <div class="mb-6">
            ...
            <div class="relative">
              ...
              <input
                ...
                required v-model="contact.phone"
              />
            </div>
          </div>
