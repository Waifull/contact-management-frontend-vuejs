<template>
  <div>
    <div class="flex items-center mb-6">
      <RouterLink :to="`/dashboard/contacts/${id}`" class="text-blue-400 hover:text-blue-300 mr-4 flex items-center transition-colors duration-200"> <i class="fas fa-arrow-left mr-2"></i> Back to Contact Details </RouterLink>
      <h1 class="text-2xl font-bold text-white flex items-center"><i class="fas fa-plus-circle text-blue-400 mr-3"></i> Add New Address</h1>
    </div>
          ...
          <div class="mb-5">
            ...
            <div class="relative">
              ...
              <input
                ...
                required v-model="address.street"
              />
            </div>
          </div>
            ...
            <div>
              ...
              <div class="relative">
                ...
                <input
                  ...
                  required v-model="address.province"
                />
              </div>
            </div>
          </div>
            ...
            <div>
              ...
              <div class="relative">
                ...
                <input
                  ...
                  required v-model="address.country"
                />
              </div>
            </div>
            <div>
              ...
              <div class="relative">
                ...
                <input
                  ...
                  required v-model="address.postal_code"
                />
              </div>
            </div>
          </div>
